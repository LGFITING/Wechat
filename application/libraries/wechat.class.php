...
// :TODO: Is there any more datatype we should be in the lookout for? (Object?)
    ...
    public function getOauthAccessToken() {
        ...
        if ($result) {
            ...
            // 设置refresh_token 30天有效期
            $this->__CI->session->set_tempdata('refresh_token', $json['refresh_token'], 2592000);
            // 设置oauth_access_token 2小时有效期
            $this->__CI->session->set_tempdata('oauth_accsess_token', $json['access_token'], $json['expires_in']);
            $this->__CI->session->set_userdata('oauth_openid', $json['openid']);
            return $json;
        }
        return false;
    }
